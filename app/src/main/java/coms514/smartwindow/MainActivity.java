...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailTextView.setText(email.toLowerCase());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        else if (id == R.id.nav_operate)
        {
            ...
            Intent operate = new Intent(MainActivity.this,Operate.class).putExtra("email",email);
            startActivity(operate);
        }
        else if (id == R.id.nav_settings)
        {
            Intent i = new Intent(this,Condition.class);
            startActivity(i);
        }
